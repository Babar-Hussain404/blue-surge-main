...
const Profile_User_Info_Card = () => {
  return (
    <>
      <div class="widget Profile_User_Info_Card">
        <div class="widget-advanced">
          {/* <!-- Widget Header --> */}
          <div className="widget-header text-center" style={{ padding: "0%" }}>
            {/* Background IMG */}
            <div
          ...
          <div class="widget-main User_info">
            ...
            <div className="User_Contant">
              <div className="User_Profile_Name_Section">
                <div>
                  <span className="User_Profile_Name">Muhammad Tauheed</span>
                </div>
                <span>
                  <img src={sendGreen} /> Lahore District, Punjab, Pakistan
                </span>
              </div>
              ...
              <p className="Normal_Text" style={{ wordWrap: "break-word" }}>
                As a Farmer, 80+ projects in agricultural field, I am eager to
                leverage my skills and expertise in agricultural world.
              </p>

              <div className="Profile_Contact_BTN">
                <button className="Profile_Contact_Info">Contact info</button>
...
export default Profile_User_Info_Card;
